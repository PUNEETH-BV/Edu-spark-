...
export default function SignupPage() {
  ...
  const [googleStep, setGoogleStep] = useState(1); // 1 = email, 2 = name
  ...
  function handleGoogleEmailNext() {
    ...
    setGoogleError('');
    // Auto-generate a default name from email
  ...
  async function handleGoogleFinalSignUp() {
      ...
      <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-grid" style={{ background: '#0d0d1a' }}>
        ...
        <div className="relative z-10 w-full max-w-md animate-slide-up">
          ...
          <div className="glass rounded-3xl p-8">
            ...
            {/* ── Google Sign Up Button (top, prominent) ── */}
            <button
              type="button"
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="px-2 bg-[#121227] text-[#8b8bb5]">Or sign up with email</span></div>
            </div>
            ...
            <p className="text-center text-xs mt-4" style={{ color: '#6b6b8a' }}>
            ...
            <p className="text-center text-sm mt-5" style={{ color: '#8b8bb5' }}>
              ...
              <>
                ...
                <div style={{ marginBottom: '24px' }}>
                  <input
                    ...
                    onKeyDown={e => e.key === 'Enter' && handleGoogleFinalSignUp()}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <button
                    type="button"
                    onClick={handleGoogleFinalSignUp}
